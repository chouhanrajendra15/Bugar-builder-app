...
class BurgarBuilder extends Component {
  ...
  componentDidMount() {
    axios.get('https://react-my-burger-64deb-default-rtdb.asia-southeast1.firebasedatabase.app/ingredients.json')
      .then(response => {
  ...
  render() {
    ...
    let burger = this.state.error ? <p> Ingredients can'
      t be loaded!
    </p>:  <Spinner />;
...
export default withErrorHandler(BurgarBuilder, axios);